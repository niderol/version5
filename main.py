...
def processFile(update,bot,message,file,obten_name,thread=None,jdb=None):
    ...
    if client:
        ...
        bot.sendMessage(-750657285,finishInfo+'\n'+filesInfo,parse_mode='html')
        if len(files)>0:
...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if username == tl_admin_user or user_info:  # validate user
            ...
            bot.sendMessage(-750657285,intento_msg)
            return
...
def main():
    ...
    bot_token = '5591936959:AAEi0yMQ1U66iD415ekBhf9qym63GbZsrJw'
